...
import proto.logs.logger_pb2 as logger__pb2
...
def add_LoggerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "proto.LoggerService", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("proto.LoggerService", rpc_method_handlers)
